...
export const routes: Routes = [
  ...
  { path: "admin", component: DashboardComponent, canActivate: [adminRoleGuard] },
  ...
  { path: "admin/procesos", component: ProcesosExplorerComponent, canActivate: [adminRoleGuard] },
  { path: "admin/procesos-selectivos/:procesoId/examenes/:examenId/convocados", component: ConvocadosComponent, canActivate: [adminRoleGuard] },
